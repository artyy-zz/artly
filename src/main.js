...
const translations = {
  sq: {
    ...
    cta: {
      ...
      ideaTitle: "Keni një ide për biznesin tuaj?",
      ideaButton: "Le ta ndërtojmë",
      fastTitle: "Gati për një faqe që duket serioze në telefon?",
      fastButton: "Na shkruani",
    },
    hero: {
      ...
      trustLine: "Përshtatur për telefona, laptop dhe çdo ekran.",
      ...
      flow: [
        {
          step: "Hapi 1",
          icon: "spark",
          title: "Ide & Planifikim",
          text: "E kuptojmë biznesin, klientët dhe qëllimin e faqes.",
        ...
        },
        {
          ...
          text: "Ndërtojmë një faqe të pastër, të shpejtë dhe të menduar për telefon.",
        ...
        },
        {
          ...
          text: "Faqja del online dhe rregullohet për performancë e kontakt.",
          chips: ["Online", "Më shumë besim", "Kontakt", "Rritje"],
          visual: "launch",
        },
      ],
      cards: [
        ...
        { icon: "cart", title: "Dyqan online", text: "Dyqan online për produkte dhe porosi." },
        ...
        { icon: "server", title: "Hostim & Mirëmbajtje", text: "Domain, hostim dhe përditësime." },
      ],
    },
    projects: {
      eyebrow: "Ide",
      ...
      cards: [
        { title: "Vizioni i Interierit", category: "Koncept mobilieri", text: "Koncept premium për mobilieri dhe interier.", tags: ["Koncept", "Gati për telefon"], image: "assets/projects/art-home.png" },
        { title: "Produkte Teknologjike", category: "Koncept produkti", text: "Faqe e pastër për produkte teknologjike.", tags: ["Koncept", "Shpejt"], image: "assets/projects/artnet.png" },
        { title: "Shkolla e së Ardhmes", category: "Koncept edukimi", text: "Webfaqe e qartë për shkolla dhe njoftime.", tags: ["Koncept", "Gati për telefon"], image: "assets/projects/school.png" },
        { title: "Paneli i Biznesit", category: "Panel biznesi", text: "Panel modern për porosi dhe klientë.", tags: ["Panel", "Personalizuar"], image: "assets/projects/business-dashboard.png" },
        { title: "Dyqan Digjital", category: "Dyqan online", text: "Dyqan online ku produktet duken premium.", tags: ["Dyqan", "Telefon"], image: "assets/projects/artnet-store.png" },
        { title: "Restorant Kinematik", category: "Koncept restoranti", text: "Koncept restorani me menu dhe rezervime.", tags: ["Koncept", "Kontakt"], image: "assets/projects/restaurant.png" },
      ],
    },
    process: {
      eyebrow: "Procesi",
      ...
      steps: [
        ...
        { title: "Lansohet online", text: "Faqja juaj del online." },
      ],
    },
    contact: {
      eyebrow: "Kontakt",
  ...
  en: {
    ...
    cta: {
      ...
      ideaTitle: "Have an idea for your business?",
      ideaButton: "Let’s build it",
      fastTitle: "Ready for a website that feels serious on mobile?",
      fastButton: "Message us",
    },
    hero: {
      eyebrow: "Artly Digital Studio",
      ...
      trustLine: "Made for phones, laptops, and every screen.",
  ...
  de: {
    ...
    cta: {
      ...
      projects: "Ideen ansehen",
      mobileContact: "Kontakt",
      ideaTitle: "Haben Sie eine Idee für Ihr Unternehmen?",
      ideaButton: "Lassen Sie es uns bauen",
      fastTitle: "Bereit für eine Website, die mobil seriös wirkt?",
      fastButton: "Schreiben Sie uns",
    },
    hero: {
      eyebrow: "Artly Digital Studio",
      ...
      trustLine: "Optimiert für Telefon, Laptop und jeden Bildschirm.",
